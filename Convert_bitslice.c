...
#if MaxCountMessage==256 // __m256i


//!!! Лучше сделать macros ConvertBitslice_32x32, т.к. слишком часто вызывается + не очень хорошо много * offset, 
// в макросе offset будет константой при компиляции
